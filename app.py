...
@app.route("/pay")
def pay():
    return render_template("pay.html", BANK_ACCOUNT_NAME=BANK_ACCOUNT_NAME, BANK_ACCOUNT_NUMBER=BANK_ACCOUNT_NUMBER, BANK_ACCOUNT_SORTCODE=BANK_ACCOUNT_SORTCODE)
